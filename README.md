...
## More help
The [notebooks/](notebooks/) directory contains two Jupyter notebooks describing the data exploration process and how to produce the plots generated by this package. It is recommended to run cells in order. The notebooks are not intended to replace the functionality of this package!
